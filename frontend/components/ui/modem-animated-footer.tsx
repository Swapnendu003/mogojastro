...
export const Footer = ({
  ...
  return (
    <section className={cn("relative w-full mt-0 overflow-hidden", className)}>
      <footer
        className="border-t mt-20 relative text-foreground"
        style={{ background: backgroundColor || 'hsl(var(--background))' }}
      >
          ...
          <div className="flex flex-col mb-12 sm:mb-20 md:mb-0 w-full">
            <div className="w-full flex flex-col items-center">
              <div className="space-y-2 flex flex-col items-center flex-1">
                ...
                <p className="font-semibold text-center w-full max-w-sm sm:w-96 px-4 sm:px-0 opacity-80">
                  {brandDescription}
                </p>
              </div>
        ...
        {/* Bottom logo */}
        <div className="absolute hover:border-[#FF6B2C] duration-400 drop-shadow-[0_0px_20px_rgba(0,0,0,0.5)] dark:drop-shadow-[0_0px_20px_rgba(255,255,255,0.3)] bottom-24 md:bottom-20 backdrop-blur-sm rounded-3xl bg-background/60 left-1/2 border-2 border-border flex items-center justify-center p-3 -translate-x-1/2 z-10">
          <div className="w-12 sm:w-16 md:w-24 h-12 sm:h-16 md:h-24 bg-[#FF6B2C] rounded-2xl flex items-center justify-center shadow-lg">
            {brandIcon || (
